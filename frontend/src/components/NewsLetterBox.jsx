...
const NewsLetterBox = () => {
  ...
  return (
    <div className='mt-10 text-center'>
      ...
      <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row items-center w-full gap-3 px-3 mx-auto my-6 border sm:w-1/2'>
        <input
          className='w-full outline-none sm:flex-1 rounded-full px-4 py-3 border border-gray-300'
          type="email"
        ...
        />
        <button type='submit' disabled={loading} className='w-full sm:w-auto px-10 py-4 text-xs text-white bg-black rounded-full disabled:opacity-60'>
